...
- ``(intermezzo)``, ``(solo)``, ``(tussenspel)``, ``(muziek)``, ``(stoppen)``, ``(einde)`` - Als hierop wordt geklikt gebeurd er praktisch  hetzelfde als wanneer het scherm leeg gemaakt wordt. (voordeel van dit soort blokjes is dat je door kunt blijven klikken met pg up / pg dn bijvoorbeeld.)
